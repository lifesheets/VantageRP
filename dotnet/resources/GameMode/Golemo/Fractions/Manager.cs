...
namespace Golemo.Fractions
{
    ...
    { // Revision 3.0
        ...
        public static void putmoneyFrac(Player player, int money)
        {
            ...
            if (money > 0)
            {
                ...
                {
                    Notify.Succ(player, $"Not enough money");
                    return;
                }
        ...
        public static void takemoneyFrac(Player player, int money)
        {
            ...
            if (money > 0)
            {
                ...
                {
                    Notify.Succ(player, $"Not enough money on the fraction account");
                    return;
                }
                Fractions.Stocks.fracStocks[Main.Players[player].FractionID].Money -= money;
                Fractions.Stocks.fracStocks[Main.Players[player].FractionID].UpdateLabel();
            ...
            else
            {
                ...
                switch (action)
                {
                    case "load_mats":
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"You are not in {Fractions.Manager.getName(player.GetData<int>("ONFRACSTOCK"))}", 3000);
                            return;
                        }
                    ...
                    case "load_drugs":
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"You are not in ~y~{Fractions.Manager.getName(player.GetData<int>("ONFRACSTOCK"))}", 3000);
                            return;
                        }
        ...
        public static void interactPressed(Player player, int interact)
        {
            switch (interact)
            {
                ...
                case 33:
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"You are not in {Manager.getName(player.GetData<int>("ONFRACSTOCK"))}", 3000);
                        return;
                    }
    ...
    class MatsWar : Script
    {
        ...
        public static void interact(Player player)
        {
            ...
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"You can't do it", 3000);
                return;
            }
            if (!player.IsInVehicle)
            {
            ...
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"This machine cannot carry mats", 3000);
                return;
            }
