    ...
    public class Voice : Script
    {
        ...
        public static void PhoneCallCommand(Player player, Player target)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Unable to get mobile phone", 3000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Subscriber out of network coverage area", 3000);
                }
        ...
        public static void PhoneCallAcceptCommand(Player player)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"No one is calling you at the moment", 3000);
                    return;
                }
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"You have received a call from {targetName}", 3000);
        ...
        public static void PhoneHCommand(Player player)
        {
            try
            {
                ...
                {
                    if (!player.HasData("IS_DYING") && !player.GetData<bool>("CUFFED")) Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"You are not on the phone at the moment", 3000);
                    return;
                }
