...
namespace Golemo.Houses
{
    class Realtor : Script
    {
        ...
        private static Vector3 PositionRealtor = new Vector3(-570.4495, -394.9133, -303.9366);
        ...
        public static void EnterShapeRealtor()
        {
            try
            {
               ...
               // blip = NAPI.Blip.CreateBlip(374, PositionRealtor, 0.6f, 2, "Авито", shortRange: true, dimension: 0);
