...
namespace Golemo.Jobs
{
    class OrangeFarm : Script
    {
        ...
        private static int JobPayment1 = 500;
        private static int JobPayment2 = 1000;
        ...
        private static void OrangeWorkStateDay1(Player player)
        {
            ...
            else
            {
                ...
                Trigger.ClientEvent(player, "createCheckpoint", 15, 1, Checkpoints1LVL[check].Position, 1, 0, 255, 0, 0);
        ...
        private static void OrangeWorkStateDay2(Player player)
        {
            ...
            else
            {
                ...
                Trigger.ClientEvent(player, "createCheckpoint", 15, 1, Checkpoints2LVL[check].Position, 1, 0, 255, 0, 0);
            ...
            try
            {
                if (player.HasData("ON_WORK"))
                {
                    if (player != null && Main.Players.ContainsKey(player))
                    {
                        ...
                        Trigger.ClientEvent(player, "createCheckpoint", 15, 1, Checkpoints1LVL[nextCheck].Position, 1, 0, 255, 0, 0);
                ...
                if (player.HasData("ON_WORK2"))
                {
                    if (player != null && Main.Players.ContainsKey(player))
                    {
                        ...
                        player.SetData("WORKCHECK", nextCheck);
                        Trigger.ClientEvent(player, "createCheckpoint", 15, 1, Checkpoints2LVL[nextCheck].Position, 1, 0, 255, 0, 0);
