...
namespace Golemo.Core
{
    class Weapons : Script
    {
        ...
        {
           { ItemType.Pistol, ItemType.PistolAmmo2 },
            { ItemType.CombatPistol, ItemType.PistolAmmo2 },
            { ItemType.Pistol50, ItemType.PistolAmmo2 },
            { ItemType.SNSPistol, ItemType.PistolAmmo2 },
            { ItemType.HeavyPistol, ItemType.PistolAmmo2 },
            { ItemType.VintagePistol, ItemType.PistolAmmo2 },
            { ItemType.MarksmanPistol, ItemType.PistolAmmo2 },
            { ItemType.Revolver, ItemType.PistolAmmo3 },
            { ItemType.APPistol, ItemType.PistolAmmo2 },
            { ItemType.FlareGun, ItemType.PistolAmmo2 },
            { ItemType.DoubleAction, ItemType.PistolAmmo2 },
            { ItemType.PistolMk2, ItemType.PistolAmmo2 },
            { ItemType.SNSPistolMk2, ItemType.PistolAmmo2 },
            { ItemType.RevolverMk2, ItemType.PistolAmmo3 },

            { ItemType.MicroSMG, ItemType.PistolAmmo },
            { ItemType.MachinePistol, ItemType.PistolAmmo },
            { ItemType.SMG, ItemType.PistolAmmo },
            { ItemType.AssaultSMG, ItemType.RiflesAmmo },
            { ItemType.CombatPDW, ItemType.PistolAmmo },
            { ItemType.MG, ItemType.RiflesAmmo },
            { ItemType.CombatMG, ItemType.RiflesAmmo },
            { ItemType.Gusenberg, ItemType.PistolAmmo2 },
            { ItemType.MiniSMG, ItemType.PistolAmmo },
            { ItemType.SMGMk2, ItemType.PistolAmmo },
            { ItemType.CombatMGMk2, ItemType.RiflesAmmo },

            { ItemType.AssaultRifle, ItemType.RiflesAmmo },
            { ItemType.CarbineRifle, ItemType.CarabineAmmo },
            { ItemType.AdvancedRifle, ItemType.RiflesAmmo },
            { ItemType.SpecialCarbine, ItemType.CarabineAmmo },
            ...
            { ItemType.CarbineRifleMk2, ItemType.CarabineAmmo },
            { ItemType.SpecialCarbineMk2, ItemType.CarabineAmmo },
            ...
            { ItemType.HeavyShotgun, ItemType.HeavyRiflesAmmo },
            ...
            { ItemType.Parachute, ItemType.Parachute },
        };
        ...
        public static string GetSerialFrac(bool isFraction, int id)
        {
            var fractionType = Fractions.Manager.GovTags[id];
            var serial = fractionType + "-" + id * 100000 + FractionsLastSerial[id];
        ...
        public static void RemoteEvent_changeWeapon(Player player, int key)
        {
            try
            {
                ...
                switch (key)
                {
                    ...
                    case 2:
                        {
                            var wItem = nInventory.Items[UUID].FirstOrDefault(i => nInventory.WeaponsItems.Contains(i.Type) && WeaponsAmmoTypes[i.Type] == ItemType.PistolAmmo2);
                            if (wItem != null) Items.onUse(player, wItem, -1);
                        }
                        return;
                    case 3:
