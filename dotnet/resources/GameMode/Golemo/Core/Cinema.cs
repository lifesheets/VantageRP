...
class Cinema : Script
{
    ...
    public static void CinemaOpen(Player player, bool toggle)
    {
        if(toggle == true)
        {
            if(cinema_open == true)
            {
                Notify.Succ(player, "Cinema already open", 3000);
                return;
            }
        ...
        else
        {
            ...
            {
                Notify.Error(player, "The cinema is already closed", 3000);
                return;
            }
    ...
    {
        string url_replace = url.Replace("https://www.youtube.com/watch?v=", "https://www.youtube.com/watch?v=N-xHcvug3WI");
