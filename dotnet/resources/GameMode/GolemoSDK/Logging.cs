...
namespace GolemoSDK
{
    public class nLog
    {
        ...
        /// <summary>
        /// Print plain text to the console with the desired flag
        /// </summary>
        ...
        /// <summary>
        /// Print plain text to the console with the desired flag asynchronously
        /// </summary>
        ...
        /// <summary>
        /// Print debug text to the console with the desired flag asynchronously
        /// </summary>
        /// <param name="text">Выводимый текст</param>
        /// <param name="logType">Флаг. Указывает, как нужно пометить строку</param>
